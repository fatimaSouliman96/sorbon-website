        ...
        <>
            {
                showResultVenueRows.map((row, index) => {
                    return <tr key={index} className="border border-[#cbd5e1]  hover:bg-gray-50 transition">
                        <td className="px-3 py-2 border-r-0  text-black text-sm font-normal">{row.title}</td>
                        <td className="px-3 py-2 border-r-0  text-black text-sm font-normal">{row.city}</td>
                        <td className="px-3 py-2 border-r-0  text-black text-sm font-normal">{row.start}</td>
                        <td className="px-3 py-2 border-r-0  text-black text-sm font-normal">{row.end}</td>
