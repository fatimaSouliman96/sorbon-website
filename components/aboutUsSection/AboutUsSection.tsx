    ...
    return (
        <div className='lg:flex-row gap-4 md:flex-row flex-col flex bg-[#DDDBEF] w-full px-[4.5rem] py-12'>
            <div className='lg:w-[50%] md:w-[50%] w-full'>
                <h1 className='text-[32px] font-semibold text-secondary'>
                    ABOUT US
                </h1>
                <p className='text-[28px] font-normal text-secondary pt-12 leading-10 pr-4'>
                 Our goal is to take your practical learning experience to a whole other level and be successful Together.
                </p>
                <p className='text-[20px] font-normal text-secondary pt-10'>
                  Maximize your potential in emerging business trends with our professional training courses
