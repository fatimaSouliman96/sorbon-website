...
import { CategoriesData, City, Course, SessionCource } from '@/types/types'
...
export async function generateStaticParams() {
  const blogs = await getData<cityDetils>('get-city-courses-and-categories');
    ...
    <div className='w-full' >
      ...
      <div className='px-12 py-8 w-full bg-[#f0effa]' >
        <div className='flex justify-between items-center' >
          <h1 className='lg:text-3xl text-2xl  font-semibold text-secondary uppercase '>
            Discover courses in {data.city.h1}
          </h1>
        ...
        <div className='w-full pt-6 flex flex-col gap-2' >

          {
            data?.courses.length !== 0 ?
              ...
              :
              <p className='lg:text-lg text-lg text-center  font-semibold text-secondary uppercase'>
