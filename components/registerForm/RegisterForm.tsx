        ...
        <>
            ...
            <div className="p-4">
                <div className="w-full " >
                    <p className="text-2xl text-secondary font-semibold text-left">Participant Information</p>
                    <div className="grid grid-cols-2 pt-1 gap-x-8 gap-y-1">
                        <div>
                            {/* <label className="text-sm font-semibold text-secondary"></label> */}
                        ...
                        <div>
                            <input placeholder="Job Title*" className="placeholder:text-secondary placeholder:text-sm placeholder:font-semibold text-sm mt-2 w-full font-semibold text-secondary p-1 bg-transparent border-b-secondary border-b outline-none" type="email" />
                        </div>
                    </div>
                </div>
                <div className="w-full pt-1 " >
                    ...
                    <div className="grid 721max:grid-cols-2 grid-cols-4 pt-1 gap-x-8 gap-y-1">
                        ...
                        <div>
                            <input placeholder="Country*" className="placeholder:text-secondary placeholder:text-sm placeholder:font-semibold text-sm mt-2 w-full font-semibold text-secondary p-1 bg-transparent border-b-secondary border-b outline-none" type="text" />
                        </div>
                        <div>
                            <input placeholder="City*" className="placeholder:text-secondary placeholder:text-sm placeholder:font-semibold text-sm mt-2 w-full font-semibold text-secondary p-1 bg-transparent border-b-secondary border-b outline-none" type="text" />
                        </div>

                    </div>
                </div>
                <div className="w-full pt-1 " >
                    <p className="text-2xl text-secondary font-semibold text-left">Person Responsible for Training and Development in the Company</p>
                    <div className="grid grid-cols-2 pt-1 gap-x-8 gap-y-1">
                        <div>
                            <input placeholder="Full Name*" className="placeholder:text-secondary placeholder:text-sm placeholder:font-semibold text-sm mt-2 w-full font-semibold text-secondary p-1 bg-transparent border-b-secondary border-b outline-none" type="text" />
                        </div>
                        ...
                        <div>
                            <input placeholder="Postion*" className="placeholder:text-secondary placeholder:text-sm placeholder:font-semibold text-sm mt-2 w-full font-semibold text-secondary p-1 bg-transparent border-b-secondary border-b outline-none" type="email" />
                        </div>
                    </div>
                </div>
            </div>
