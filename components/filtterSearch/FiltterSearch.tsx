...
export default function FiltterSearch() {
    ...
    return (
        <div className='sm:gap-4 lg:gap-12 md:gap-8 justify-center w-[90%]  sm:mt-8 md:mt-12 lg:lg-14  flex gap-4 flex-col items-center m-auto bg-[#F0EFFA66] backdrop-blur-[20px] p-6 rounded-[10px] '>
