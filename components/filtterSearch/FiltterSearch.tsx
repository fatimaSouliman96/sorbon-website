...
export default function FiltterSearch() {
    ...
    return (
        <div className='sm:gap-4 gap-2 ustify-center w-[90%] mt-8 md:mt-12 lg:lg-16  flex  flex-col items-center m-auto bg-[#F0EFFA66] backdrop-blur-[20px] p-6 rounded-[10px] '>
